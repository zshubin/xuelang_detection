...
CLASSES = ['diaowei', 'maoban', 'zhadong', 'bianbaiyin', 'bianquewei',
           'bianzhadong','bianzhenyan','cadong','camao', 'cashang',
           'cusha', 'diaogong', 'diaojing', 'erduo', 'gongsha',
           'houboduan','huangzi','huibian','jiandong', 'jiedong',
           'jinsha', 'jingcusha', 'jingtiaohua', 'qianjie','lengduan',
           'maodong','maoli','pobian','podong',
           'maodong', 'quejing','quewei','tiaohua','jingcusha',
           'wuzi','xianyin','xiuyin','youzi','zhadong',
           'zhasha','zhashu','zhengniyin','zhiru','zhishu']

pascal_path = '/data/train/'
img_dir ='./data/train/N/'
data_path = os.path.join(pascal_path,'xml')
